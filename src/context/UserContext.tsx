...
export function UserProvider({ children }: { children: ReactNode }) {
  ...
  const completeOnboarding = (p: UserProfile, prebuiltFolders?: UserFolder[]) => {
    // Ein erzwungener Durchlauf endet hier — sonst kaeme man nie wieder heraus.
    onboardingFreigeben()
    setErzwungen(false)
  ...
  return (
    <UserContext.Provider
      value={{
        profile,
        // Der Onboarding-Reset in den Dev-Werkzeugen setzt eine Marke. Ohne sie
        // half das Loeschen der lokalen Daten nichts: Das Profil liegt auch in
        // Supabase und wurde beim naechsten Laden sofort wieder heruntergeladen
        // — man landete direkt wieder in der App statt im Onboarding.
        isOnboarded: profile !== null && !erzwungen,
        personalEntries,
        generatedNotes,
        userNotes,
        userFolders,
