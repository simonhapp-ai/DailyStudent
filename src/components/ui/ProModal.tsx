...
type ProFeature = 'ki-zusammenfassung' | 'ki-korrektur' | 'lernplan' | 'karteikarten'
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col justify-end">
      ...
      <div className="relative max-w-lg mx-auto w-full bg-surface border-t border-border rounded-t-2xl px-5 pt-5 pb-10 z-10">
        ...
        <div className="w-12 h-12 rounded-btn bg-accent-soft flex items-center justify-center mb-4">
        ...
        <div className="bg-background border border-border rounded-card p-1 flex mb-4">
          <button
            ...
            className={`flex-1 py-2.5 rounded-btn text-sm font-medium transition-all duration-150 ${
              plan === 'annual' ? 'bg-accent text-white' : 'text-text-secondary'
            }`}
          >
            Jährlich · €5/Mo
          ...
          <button
            ...
            className={`flex-1 py-2.5 rounded-btn text-sm font-medium transition-all duration-150 ${
              plan === 'monthly' ? 'bg-accent text-white' : 'text-text-secondary'
            }`}
          >
            Monatlich · €7,99
          </button>
