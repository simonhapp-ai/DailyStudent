        ...
        {showAskBar ? (
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`w-8 h-8 rounded-btn flex items-center justify-center shrink-0 transition-all ${askInput.trim() ? 'bg-accent text-on-accent hover:opacity-90 active:scale-95' : 'bg-surface-hover text-text-muted cursor-not-allowed'}`}
            >
            ...
            <div className="px-4 py-4 space-y-2.5" style={{ paddingBottom: 'max(1.5rem, env(safe-area-inset-bottom, 0px))' }}>
              {folderId && (
                <button
                  ...
                  className="w-full h-12 rounded-pill bg-accent text-on-accent text-sm font-semibold hover:opacity-90 active:scale-95 transition-all"
                >
