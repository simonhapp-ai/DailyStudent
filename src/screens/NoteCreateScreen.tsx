...
type NoteBlock = TextBlock | PhotoBlock | DrawingBlock
...
export function NoteCreateScreen() {
  ...
  const hasUserContent = blocks.some((b) =>
    ...
    : b.type === 'photo' ? b.attachments.length > 0
    : b.dataUrl !== null
  ) || qaItems.length > 0
    ...
    <div className="flex flex-col bg-background" style={{ height: '100dvh' }}>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {blocks.map((block, i) => {
          ...
          return renderDrawingBlock(block, i === 2)
        })}
              ...
              <div className="overflow-y-auto flex-1">
                ...
                >
                  <div className="w-8 h-8 rounded-btn bg-surface-hover flex items-center justify-center shrink-0">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" strokeLinecap="round" strokeLinejoin="round" /></svg>
                  </div>
                  <div>
